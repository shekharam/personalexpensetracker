...
app.config['MYSQL_USER'] = 'f2Xn47FGhP'
app.config['MYSQL_PASSWORD'] = 'R8GpBqFikQ'
app.config['MYSQL_DB'] = 'f2Xn47FGhP'

app.config["MAIL_SERVER"] = 'smtp.gmail.com'
app.config['MAIL_PORT']=465
app.config['MAIL_USERNAME']="shekharam1997@gmail.com"
app.config['MAIL_PASSWORD']=  "prabhabhawan1997"
